    ...
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">
                <a href="{{ URL::previous() }}" class="btn btn-secondary btn-fix">Back to buying</a>
                <a href="{{url('user/buying/give/rating')}}" class="btn btn-secondary btn-fix">Give Ratting</a>
            </div>
    ...
    <div class="d-flex align-items-center mb-5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($product->status == 1 || $product->status == 2)
                                                   <u> <a href="{{url('user/buying/give/rating',$product->id)}}">Give Reating</a> </u>
                                                @else
                                                    Shipping Not Complete
                                                @endif
                                            </td>
                                        </tr>
                                        <?php 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="ibox">
                        <?php
                            $about_seller = DB::table('users')->where('id',$buyed_single_product->seller_id)->first();
                             $about_seller_shop = DB::table('shops')->where('id',$buyed_single_product->seller_shop_id)->first();
                        ?>
                            <div class="ibox-body">
                                <h5 class="font-strong mb-4">Seller Information</h5>
                                <div class="row align-items-center mb-3">
                                    <div class="col-4 text-light">Seller</div>
                                    <div class="col-8">{{$about_seller->name}}</div>
                                </div>
                                <div class="row align-items-center mb-3">
                                    <div class="col-4 text-light">Shop</div>
                                    <div class="col-8">{{$about_seller_shop->shop_name}}</div>
                                </div>
                                <div class="row align-items-center mb-3">
                                    <div class="col-4 text-light">Address</div>
                                    <div class="col-8">{{$about_seller_shop->address}}</div>
                                </div>
                                <div class="row align-items-center mb-3">
                                    <div class="col-4 text-light">Email</div>
                                    <div class="col-8">{{$about_seller->email}}</div>
                                </div>
                                <div class="row align-items-center">
                                    <div class="col-4 text-light">Phone</div>
                                    <div class="col-8">{{$about_seller->phone}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
