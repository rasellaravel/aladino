      ...
      <div class="wsmain">
        <nav class="wsmenu clearfix">
          <ul class="mobile-sub wsmenu-list">
            ...
            <li><a href="#" class="navtext"><span></span> <span>MegaMenu 1</span></a>
             ...
             <li><a href="#" class="navtext"><span></span> <span>MegaMenu 2</span></a>
              <div class="megamenu clearfix">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-lg-3 col-md-12">
            ...
            <li><a href="#" class="navtext"><span></span> <span>MegaMenu 3</span></a>
              <div class="megamenu clearfix">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-lg-3 col-md-12">
            ...
            <li><a href="#" class="navtext"><span></span> <span>MegaMenu 4</span></a>
              <div class="megamenu clearfix">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-lg-3 col-md-12">
